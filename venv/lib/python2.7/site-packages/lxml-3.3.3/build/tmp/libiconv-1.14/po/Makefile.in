...
# ${SHELL} /Users/Soderstrom/Development/hoodlyhej/venv/lib/python2.7/site-packages/lxml-3.3.3/build/tmp/libiconv-1.14/build-aux/install-sh does not start with $(SHELL), so we add it.
# In automake >= 1.10, $(top_builddir)/build-aux/install-sh -c -d is derived from ${MKDIR_P}, which is defined
# either as "/path/to/mkdir -p" or ".../install-sh -c -d". For these automake
# versions, $(mkinstalldirs) and $(install_sh) are unused.
mkinstalldirs = $(SHELL) ${SHELL} /Users/Soderstrom/Development/hoodlyhej/venv/lib/python2.7/site-packages/lxml-3.3.3/build/tmp/libiconv-1.14/build-aux/install-sh -d
install_sh = $(SHELL) ${SHELL} /Users/Soderstrom/Development/hoodlyhej/venv/lib/python2.7/site-packages/lxml-3.3.3/build/tmp/libiconv-1.14/build-aux/install-sh
